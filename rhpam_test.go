...
`
	...
	var inputYaml = `name: Ivan`
	schema := new(spec.Schema)
	assert.NoError(t, yaml.Unmarshal([]byte(schemaYAML), schema))
...
func setNestedMapValue(object map[string]interface{}, value interface{}, keys... string)  {
